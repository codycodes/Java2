...
public class AdventureTest {
	...
	public static void testSmallAdventure() {
		try {
			...
			System.out.println("To test, place the SmallTest.txt file in your project folder");
		}
	}
	...
	public static void testCrowtherAdventure() {
		try {
			...
			System.out.println("To test, place the CrowtherTest.txt file in your project folder");
		}
	}
